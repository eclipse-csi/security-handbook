...
For Slack and Teams, the destination should be an incoming webhook URL for a channel. This must be provided through a secure private channel to the Eclipse Foundation Security Team.
